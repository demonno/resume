...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Domain}
          {Being responsible for more than 12 services, some of the fundamential platform services, OAuth2 Authorization Service, API Gateway, 2FA and OTP.}
        \resumeItem{Processes}
          {Following continues delivery approach while software development, using TDD, improving and standartising common libraries, which are used as building blocks by different teams when implementing pytohn microservices. Standardising CI/CD pipelines.}
		\resumeItem{Communications}{Being in constant loop with Infrastructure and Infosec teams and provide support by suggesting and implementing best practices across the ecosystem in scope.}
		\resumeItem{Interviews}
          {Conducting interviews, supporting and imprving existing proccess.}
      \resumeItemListEnd
