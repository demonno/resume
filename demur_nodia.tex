...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Was responsible for existing ecosystem, which included 12+ microservices.}
        \resumeItem{\href{http://accounts.paxful.com/}{OAuth2 Service}, API Gateway, Internal admin tool, SMS, Email, 2FA, OTP Services, internal  python libraries.}
        \resumeItem{Managed communications with teams, supported integrations with our services. Standardized CI/CD pipelines.}
        \resumeItem{Set and encouraged minimum code quality standards in the team.}
      \resumeItemListEnd
...
\resumeSubheading
      ...
      \resumeItemListStart
	   \resumeItem{As a member of an agile team, implemented microservices, using async stack: \textbf{python, FastAPI, Postgresql}.}
        \resumeItem{Participated in the initial process of transitioning towards microservices architecture.}
        ...
        \resumeItem{Implemented \href{https://developers.paxful.com/}{Developers porta} backend with integration to other internal services.}
        \resumeItem{With full service ownership mindest, worked with technologies: \textbf{AWS, Kubernetes, Helm, Docker, Gitlab CI, Sentry, Elastic stack, Prometheus and Grafana}.}
      \resumeItemListEnd
...
Worked on full-cycle software development for Banking, Insurance, Transportation, Advertising industries. Meeting with clients, creating technical assignments delivering software, and in some cases conducting trainings for the users.}
...
\textit{Source of this resume is availabe at} \href{https://github.com/demonno/resume}{\underline{github.com/demonno/resume}}
